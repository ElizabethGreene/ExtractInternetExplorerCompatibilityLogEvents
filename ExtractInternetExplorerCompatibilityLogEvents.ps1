...
$events = get-winevent -path 'D:\dropbox\ellie\desktop\Eventvwr logs-CMS.evtx'
$events | foreach-object {
    $arr = $_.Properties[1].Value
    #$arr is an array containing byte, null, byte, null, etc.  I think it's a unicode string.
    $event = ""
